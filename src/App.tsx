...
function CustomerMainApp() {
    ...
    const renderPage = () => {
        switch (currentPage) {
            ...
            case 'artikli': return <Inventory />;
            case 'menu': return <Menu />;
            case 'alerts': return <Alerts />;
            case 'voice': return <VoiceOrders />;
            case 'checklists': return <Checklists />;
            case 'training': return <Training />;
            case 'settings': return <Settings />;
            case 'anonymousReports': return <AnonymousReports />;
            case 'waiter': return <WaiterApp />;
            case 'cook': return <CookApp />;
            case 'housekeeper': return <HousekeeperApp />;
        ...
        <AuthProvider>
            <BrowserRouter>
                <Routes>
                    ...
                    {/* CUSTOMER APP AREA */}
                    <Route path="/app" element={<UserRoute><CustomerMainApp /></UserRoute>}>
