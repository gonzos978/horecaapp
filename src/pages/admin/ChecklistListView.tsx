...
import { collection, getDocs, query, deleteDoc, orderBy, doc } from "firebase/firestore";
...
import { Clock, User, Search, Loader2, Trash, Pencil } from "lucide-react";
                        ...
                        <Card key={cl.id} className="hover:border-primary/50 transition-colors cursor-pointer">
                            <CardHeader className="pb-3">
                                ...
                                <div className="flex flex-wrap gap-2 mt-2">
                                    {cl.timePeriod && (
                                        <div className="flex items-center text-xs text-amber-600 font-medium bg-amber-50 px-2 py-1 rounded">
                            ...
                            <div className="flex gap-2">
                                <Button variant="outline" size="sm"onClick={() => navigate(`../edit-checklist/${cl.id}`)}>
                                    Edit
                                </Button>
